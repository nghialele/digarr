...
describe('proxyAuthMiddleware', () => {
  ...
  // Note: In tests, getSocketIp() returns '127.0.0.1' (no real socket).
  // Trust '127.0.0.0/8' to test the happy path. For untrusted scenarios,
  // use a CIDR that excludes 127.x.x.x (e.g., '10.0.0.0/8').
